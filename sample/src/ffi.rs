...
use crate::params::{
    DecryptDataParams, GenerateReportParams, NewKeypairParams,
};
use crate::{
    decrypt_data_internal_v1, generate_report_internal_v1,
    new_keypair_internal_v1,
};
...
#[no_mangle]
extern "C" fn new_keypair_v1(params_vtl0: *const NewKeypairParams) -> HRESULT {
    let params_vtl1 = unsafe {
        if is_valid_vtl0(params_vtl0 as *const _, size_of::<NewKeypairParams>()) {
            *(params_vtl0 as *const NewKeypairParams)
        } else {
    ...
    match new_keypair_internal_v1(params_vtl1, &public_key_blob) {
        Ok(()) => S_OK,
        Err(e) => e.into(),
    }
}
...
#[no_mangle]
extern "C" fn new_keypair_v2(_params_vtl0: *mut NewKeypairParams) -> HRESULT {
    todo!()
}

#[no_mangle]
extern "C" fn generate_report_v1(params_vtl0: *mut GenerateReportParams) -> HRESULT {
    ...
    if let Err(e) = generate_report_internal_v1(&mut params_vtl1) {
        return e.into();
    }
...
#[no_mangle]
extern "C" fn generate_report_v2(_params_vtl0: *mut GenerateReportParams) -> HRESULT {
    todo!()
}

#[no_mangle]
extern "C" fn decrypt_data_v1(params_vtl0: *mut DecryptDataParams) -> HRESULT {
    let mut params_vtl1 = unsafe {
    ...
    if let Err(e) = decrypt_data_internal_v1(&mut params_vtl1, &encrypted_data, &mut tag) {
        return e.into();
    }
...
#[no_mangle]
extern "C" fn decrypt_data_v2(_params_vtl0: *mut NewKeypairParams) -> HRESULT {
    todo!()
}
